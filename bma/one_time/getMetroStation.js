...
///////////////////////////////////////////////////////////////////////////
//// This Script Is only to save the metro stations into the database /////
///////////////////////////////////////////////////////////////////////////

// Connection to the database
var databaseUrl = "stops"; // "username:password@example.com/mydb"
var collections = ["metroStations", "reports"]
...
$.ajax({
	...
	success: function(data){
		...
		for(i=0; i<station.length; i++){
			...
			db.metroStations.save({ id: station[i].id, longitude: station[i].longitude, latitude: station[i].latitude, name: station[i].name }, 
