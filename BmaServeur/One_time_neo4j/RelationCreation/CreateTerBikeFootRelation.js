/******************
* filename: CreateTerBikeFootRelation.js
* date: 11/02/13
...
// This file create the relations between each bike Stops and TerStops by foot
...
*/
function compareBikeTer(bikeStop){
  ...
  for(i=0; i<terData.length; i++){
    ...
    if(terData[i].Stop_id != bikeStop.BikeStop_id){
    
      // Get the approximative distance
      getApproximativeFootDistance(terData[i], bikeStop);
    }
  }
}
