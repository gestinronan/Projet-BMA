/******************
* filename: CreateTerBusFootRelation.js
* date: 11/02/13
...
// This file create the relations between each Bus Stops and TerStops by foot
...
*/
function compareBusTer(busStop){
  ...
  for(i=0; i<terData.length; i++){
    ...
    if(terData[i].Stop_id != busStop.Stop_id){
    
      // Get the approximative distance
      getApproximativeFootDistance(terData[i], busStop);
    }
  }
}
