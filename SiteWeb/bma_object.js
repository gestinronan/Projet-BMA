...
function ItinerennesManager() {
	...
	this.modules_divs["tags"] = new String("#resultats ");
	this.modules_divs["best"] = new String("#explorez .plus-pop + ");
	this.modules_divs["last"] = new String("#explorez .plus-recents + ");
	...
	this.refreshFavoritesItinerennes = function() {
		getItinerennes("favorites");
	};
	this.refreshLastItinerennes = function() {
		getItinerennes("last");
	};
	this.refreshBestItinerennes = function() {
		getItinerennes("best");
	};
	...
	this.searchItinerennesByTags = function(tags) {
		getItinerennes("tags", tags);
	};
	/*
	 * Ajout d'une étape
	 */
...
function Itinerennes(id, transport_type, state) {
	...
	this.initializeFromResponse = function(response) {
		...
		this.likes = response.fields.likes;
		this.favorites = response.fields.favorites;
		this.date_creation = response.fields.creation_date;
		this.date_modification = response.fields.modification_date;
		this.date_publication = response.fields.publication_date;
		this.description = response.fields.description;
		this.auteur_id = response.fields.author;
...
function Etape(latitude, longitude, itinerenne) {
	...
	this.photo_url = "media/images/iti-photo.jpg";
	...
	this.getIconURL = function() {
		return "media/images/gmmarker-" + this.type + ".png";
	};
