...
\section{Contexte}
	...
	Dans le cadre, d'un cour d'innovation a l\'ESIR nous avons r\éfl\échis a ce que serai la mobilit\é dans les ann\ée \à et il est resortie des diff\érente \étude que la combinaison de plusieurs transport serai l'un des moyens fiable de fid\èliser, les gens a l'utilisations des transport en commun. Mais cette invitation au changement ne peut ce faire sans garde fou et principalement  la mise en oeuvre d'outils pour aider les gens a ce retrouver ce cette nouvel fa\çon de ce mouvoir. Dans un même temps, a eu lieu l'\éxpention grandissante du SmartPhone, outils hightech  casimment incontournable de nos jours. l'idée a donc g\èrmer que cette outils était sans outils l'un des meilleure support pour l'incitation au changement. Encore plus lorsque l'on connais l'urgence de celle ci.
	...
	Cybel assiste les premiers groupes européens dans la définition de leur strat\égie :

		M\éthode de prospective - Analyse de sc\énarios
		Portefeuilles d\'activit\és actuels et cibles
